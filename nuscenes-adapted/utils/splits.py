...
#############################################################################
"""
   create 5 dataset folds
"""
import numpy as np

data = train_track + train_detect + val
foldsize = int(len(data)/5)
folds = np.empty((5,),dtype=object)
for i in range(0,5): folds[i] = data[foldsize*i:foldsize*(i+1)]
"""
   Leave-one-out cross-validation scheme - 4 train 1 val/test
"""
LOOCV_1_train = folds[0]+folds[1]+folds[2]+folds[3]
LOOCV_1_val = folds[4]

LOOCV_2_train = folds[0]+folds[1]+folds[2]+folds[4]
LOOCV_2_val = folds[3]

LOOCV_3_train = folds[0]+folds[1]+folds[3]+folds[4]
LOOCV_3_val = folds[2]

LOOCV_4_train = folds[0]+folds[2]+folds[3]+folds[4]
LOOCV_4_val = folds[1]

LOOCV_5_train = folds[1]+folds[2]+folds[3]+folds[4]
LOOCV_5_val = folds[0]

LOOCV_train = [LOOCV_1_train, LOOCV_2_train, LOOCV_3_train, LOOCV_4_train, LOOCV_5_train]
LOOCV_val = [LOOCV_1_val, LOOCV_2_val, LOOCV_3_val, LOOCV_4_val, LOOCV_5_val] 
"""
   Exhaustive 5 Fold cross-validation scheme - 3 train 1 val 1 test
"""
E5CV_1_train = folds[0]+folds[1]+folds[2]
E5CV_1_val = folds[3]
E5CV_1_test = folds[4]

E5CV_2_train = folds[0]+folds[1]+folds[3]
E5CV_2_val = folds[2]
E5CV_2_test = folds[4]

E5CV_3_train = folds[0]+folds[1]+folds[4]
E5CV_3_val = folds[2]
E5CV_3_test = folds[3]

E5CV_4_train = folds[0]+folds[2]+folds[3]
E5CV_4_val = folds[1]
E5CV_4_test = folds[4]

E5CV_5_train = folds[0]+folds[2]+folds[4]
E5CV_5_val = folds[1]
E5CV_5_test = folds[3]

E5CV_6_train = folds[0]+folds[3]+folds[4]
E5CV_6_val = folds[1]
E5CV_6_test = folds[2]

E5CV_7_train = folds[1]+folds[2]+folds[3]
E5CV_7_val = folds[0]
E5CV_7_test = folds[4]

E5CV_8_train = folds[1]+folds[2]+folds[4]
E5CV_8_val = folds[0]
E5CV_8_test = folds[3]

E5CV_9_train = folds[1]+folds[3]+folds[4]
E5CV_9_val = folds[0]
E5CV_9_test = folds[2]

E5CV_10_train = folds[2]+folds[3]+folds[4]
E5CV_10_val = folds[0]
E5CV_10_test = folds[1]

E5CV_train = [E5CV_1_train, E5CV_2_train, E5CV_3_train, E5CV_4_train, E5CV_5_train,
              E5CV_6_train, E5CV_7_train, E5CV_8_train, E5CV_9_train, E5CV_10_train]

E5CV_val = [E5CV_1_val, E5CV_2_val, E5CV_3_val, E5CV_4_val, E5CV_5_val,
            E5CV_6_val, E5CV_7_val, E5CV_8_val, E5CV_9_val, E5CV_10_val]

E5CV_test = [E5CV_1_test, E5CV_2_test, E5CV_3_test, E5CV_4_test, E5CV_5_test,
             E5CV_6_test, E5CV_7_test, E5CV_8_test, E5CV_9_test, E5CV_10_test]
#############################################################################
#############################################################################
...
def create_splits_logs(split: str, nusc: 'NuScenes') -> List[str]:
    ...
    if split in {'train', 'val', 'train_detect', 'train_track'}:
        ...
        assert version.endswith('test'), \
            'Requested split {} which is not compatible with NuScenes version {}'.format(split, version)
    elif split.startswith('E5CV'):
        assert version.endswith('trainval'), \
            'Requested split {} which is not compatible with NuScenes version {}'.format(split, version)
    elif split.startswith('LOOCV'):
        assert version.endswith('trainval'), \
            'Requested split {} which is not compatible with NuScenes version {}'.format(split, version)
    else:
...
def create_splits_scenes(verbose: bool = False) -> Dict[str, List[str]]:
    ...
    - train_detect/train_track: Two halves of the train split used for separating the training sets of detector and
        tracker if required.
    - E5CV: Train, val, test splits for exhaustive 5 fold cross validation. (510/170/170 scenes)
    ...
    scene_splits = {'train': train, 'val': val, 'test': test,
                    ...
                    'LOOCV_1_train': LOOCV_1_train, 'LOOCV_1_val': LOOCV_1_val,
                    'LOOCV_2_train': LOOCV_2_train, 'LOOCV_2_val': LOOCV_2_val,
                    'LOOCV_3_train': LOOCV_3_train, 'LOOCV_3_val': LOOCV_3_val,
                    'LOOCV_4_train': LOOCV_4_train, 'LOOCV_4_val': LOOCV_4_val,
                    'LOOCV_5_train': LOOCV_5_train, 'LOOCV_5_val': LOOCV_5_val, 
                    'E5CV_1_train': E5CV_1_train, 'E5CV_1_val':E5CV_1_val, 'E5CV_1_test':E5CV_1_test,
                    'E5CV_2_train': E5CV_2_train, 'E5CV_2_val':E5CV_2_val, 'E5CV_2_test':E5CV_2_test,
                    'E5CV_3_train': E5CV_3_train, 'E5CV_3_val':E5CV_3_val, 'E5CV_3_test':E5CV_3_test,
                    'E5CV_4_train': E5CV_4_train, 'E5CV_4_val':E5CV_4_val, 'E5CV_4_test':E5CV_4_test,
                    'E5CV_5_train': E5CV_5_train, 'E5CV_5_val':E5CV_5_val, 'E5CV_5_test':E5CV_5_test,
                    'E5CV_6_train': E5CV_6_train, 'E5CV_6_val':E5CV_6_val, 'E5CV_6_test':E5CV_6_test,
                    'E5CV_7_train': E5CV_7_train, 'E5CV_7_val':E5CV_7_val, 'E5CV_7_test':E5CV_7_test,
                    'E5CV_8_train': E5CV_8_train, 'E5CV_8_val':E5CV_8_val, 'E5CV_8_test':E5CV_8_test,
                    'E5CV_9_train': E5CV_9_train, 'E5CV_9_val':E5CV_9_val, 'E5CV_9_test':E5CV_9_test,
                    'E5CV_10_train': E5CV_10_train, 'E5CV_10_val':E5CV_10_val, 'E5CV_10_test':E5CV_10_test}
