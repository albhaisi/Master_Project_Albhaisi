...
class DetectionEval:
    ...
    def __init__(self,
        ...
        # make metric_data_list a property of DetectionEval
        self.metric_data_list = DetectionMetricDataList()
        ...
        # Add center distances.
        # self.pred_boxes = add_nbr_lidar_points(nusc, self.pred_boxes)
    ...
    def evaluate(self) -> Tuple[DetectionMetrics, DetectionMetricDataList]:
        ...
        for class_name in self.cfg.class_names:
            for dist_th in self.cfg.dist_ths:
                ...
                self.metric_data_list.set(class_name, dist_th, md)
